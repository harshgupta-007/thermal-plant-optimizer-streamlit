...
fig.add_trace(go.Scatter(x=blocks, y=price_forecast, name="Price (₹/MWh)",mode='lines+markers', line=dict(color='red')), marker=dict(size=7, color='red', line=dict(width=1, color='darkred')), row=1, col=1, secondary_y=False)
